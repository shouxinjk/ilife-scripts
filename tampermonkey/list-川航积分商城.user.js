...
// @match        http://ffp.sichuanair.com/FFPNewWeb/Mall/List/*
// @grant        none
// ==/UserScript==

//示例URL
//http://ffp.sichuanair.com/FFPNewWeb/Mall/List/JJRY
...
(function() {
    'use strict';
    waitForKeyElements (".ProductList1 li a", item);//采集具体商品页面
    waitForKeyElements (".dl_Category dd a", list);//采集列表页面，一般是分页
})();
