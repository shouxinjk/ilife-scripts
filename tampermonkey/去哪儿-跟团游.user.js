...
//示例URL
//https://qpqd3.package.qunar.com/user/detail.jsp?id=1683229379
//https://scqq2.package.qunar.com/user/detail.jsp?id=376871613
//https://hqlx5.package.qunar.com/user/detail.jsp?id=774594307
//https://zggd3.package.qunar.com/user/detail.jsp?id=1518240234
...
(function() {
    'use strict';
    //判断是否符合URL规则
    var isMatch = window.location.href.match(/package\.qunar\.com\/user\/detail\.jsp\?id=\d+/);
...
//注意：域名前缀有变化，需要动态组装
//原始: https://qpqd3.package.qunar.com/user/detail.jsp?id=4259218086*****
//转换后: https://qpqd3.package.qunar.com/user/detail.jsp?id=4259218086
function web(link){
    var id = link.match(/id=\d+/);//id=4259218086
    return window.location.protocol+"//"+window.location.host+"/user/detail.jsp?"+id;
}
