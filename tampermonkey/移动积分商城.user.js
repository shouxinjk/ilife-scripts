...
// @match        http://jf.10086.cn/ware/*
// @match        https://jf.10086.cn/ware/*
// @grant        none
// ==/UserScript==

//示例URL
//http://jf.10086.cn/ware/100000064246069.html
//this.$ = this.jQuery = jQuery.noConflict(true);//important: to remove jQuery conflict

var debug = false;//isProduction("cmcc");
...
(function() {
    'use strict';
    waitForKeyElements (".productdetail_content_m_title", title);
    waitForKeyElements (".productdet_title a", category);
    waitForKeyElements (".small_img img", images_slide);
    ...
    waitForKeyElements (".boldprice",price_sale);
...
function images_slide(jNode){
    var img = fullUrl(jNode.attr("src").replace(/_50\.jpg/,"_480.jpg"));
    checkImage(img);
}
...
//http://jf.10086.cn/ware/100000064246069.html
function web(link){
    var id = link.match(/\d+\.html/g);//匹配后返回：100000064246069.html
    return "https://jf.10086.cn/ware/PRODUCTID".replace(/PRODUCTID/,id);
}

//转换为移动链接地址
//web: http://jf.10086.cn/ware/100000064246069.html
//wap: http://jf.10086.cn/ware/100000064246069.html
function wap(link){
    var id = link.match(/\d+\.html/g);//匹配后返回：100000064246069.html
    return "https://jf.10086.cn/ware/PRODUCTID".replace(/PRODUCTID/,id);
}
